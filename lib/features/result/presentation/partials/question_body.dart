...
class _QuestionBodyState extends State<QuestionBody> {
                ...
                Flexible(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: i <= _currentQuestion ? Border.all(width: 0.8, color: Colors.white.withOpacity(0.38)) : const Border.fromBorderSide(BorderSide.none),
  ...
  void _onSwipe(DragUpdateDetails details) {
    ...
    if(details.delta.dx > 8 && _currentQuestion < widget.interview.corrections.length - 1) {
      setState(() => _currentQuestion += 1);
    }

    // Swiping in left direction
    if(details.delta.dx < -8 && _currentQuestion > 0) {
      setState(() => _currentQuestion -= 1);
    }
  }
}
